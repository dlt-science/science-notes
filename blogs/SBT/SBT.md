...
- SBTs are redefining NFTs in the decentralised society (DeSoc), their diverse applications are expected to revolutionize everyday life and significantly impact the web3 ecosystem.
```
...
`````
 ...
 `````{margin} **DAOs**
  A Decentralised Autonomous Organization (DAO) is a blockchain-based system governed by rules encoded as computer programs known as smart contracts, with decision-making authority distributed among its members.
`````
